...
alias vi='nvim'
alias vim='nvim'
alias v:clean='rm -rf {$HOME/.cache/nvim,$HOME/.local/share/nvim,$HOME/.local/state/nvim}'
alias vi:clean='rm -rf {$HOME/.cache/nvim,$HOME/.local/share/nvim,$HOME/.local/state/nvim}'
alias nvim:clean='rm -rf {$HOME/.cache/nvim,$HOME/.local/share/nvim,$HOME/.local/state/nvim}'

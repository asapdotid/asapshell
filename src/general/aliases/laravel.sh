...
alias pa:make:class='php artisan make:class'               # Create a new PHP class
...
alias pa:make:enum='php artisan make:enum'                 # Create a new model enum
...
alias pa:make:interface='php artisan make:interface'       # Create a new PHP interface
...
alias pa:make:trait='php artisan make:trait'               # Create a new PHP trait
#  Migrate
...
# thinker
alias pa:thinker='php artisan thinker'

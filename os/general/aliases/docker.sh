...
alias dc:net:?='docker network --help'
# Docker image
alias dc:img='docker image'
alias dc:img:?='docker image --help'
...
alias dc:con:?='docker container --help'

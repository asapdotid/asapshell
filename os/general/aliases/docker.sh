...
alias dk:com:u='docker compose up -d'
alias dk:com:d='docker compose down'
alias dk:com:st='docker compose start'
alias dk:com:sp='docker compose stop'
alias dk:com:run='docker compose run'
alias dk:com:pause='docker compose pause'
alias dk:com:top='docker compose top'
alias dk:com:exec='docker compose exec'
# Docker Compose 1.x
alias dk-com='docker-compose'
alias dk-com:-v='docker-compose --version'
alias dk-com:u='docker-compose up -d'

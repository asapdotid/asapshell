...
alias g:st:l='git stash list'
alias g:st:sh='git stash show'
alias g:st:a='git stash apply'
alias g:st:an='git_stash_apply_n'
alias g:st:p='git stash pop'
alias g:st:c='git stash clear'
alias g:st:s='function _gstashsave(){ git stash save $1 };_gstashsave'
# Git with Emoji
alias g:new='gnew'
alias g:imp='gimp'
alias g:fix='gfix'

...
__GENERALFILES=($__GEXA $__GPATH $__GSYSTEM $__GDOCKER $__GANSIBLE $__GGIT $__GGIT_FLOW $__GNVM $__GNPM $__GSSH $__GTMUX $__GTMUXINATOR $__GVAGRANT $__GTERRAFORM $__GMOLECULE $__GCOMPOSER $__GCUSTOM $__GSPOTIFY_TUI)

...
alias s:r:l='sudo systemctl list-units --type=service'
alias s:r:la='sudo systemctl list-units --type=service --state=active'
alias s:r:lr='sudo systemctl list-units --type=service --state=running'
alias s:r:le='sudo systemctl list-units --type=service --state=enabled'
